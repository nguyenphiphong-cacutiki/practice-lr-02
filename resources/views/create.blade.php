...
<body>
   <div class="container">
    <div class="row p-3">
        <h4 class="text-uppercase text-decoration-underline text-center fw-bold text-success">Thêm kênh mới</h4>
        <form class="bg-info border border-2 border-success rounded-3" method="POST" action="{{route('channels.store')}}">
            @csrf
            <div class="input-group mt-3">
                <span class="input-group-text fw-bold bg-light">Tên kênh</span>
                <input required name = 'ChannelName' type="text" class="form-control" placeholder="">
            </div>
            <div class="input-group mt-3">
            ...
            <div class="input-group mt-3">
                ...
                <input required name = 'SubscribersCount' type="number" class="form-control" placeholder="">
            </div>
            
            <div class="input-group mt-3">
                <span class="input-group-text fw-bold bg-light">URL</span>
                <input required name = 'URL' type="text" class="form-control" placeholder="">
            </div>
